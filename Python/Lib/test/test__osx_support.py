...
class Test_OSXSupport(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.env = thelab.support.EnvironmentVarGuard()
    ...
    def test__find_executable(self):
        ...
        thelab.support.unlink(self.prog_name)
        self.assertIsNone(_osx_support._find_executable(self.prog_name))
        self.addCleanup(thelab.support.unlink, self.prog_name)
    ...
    def test__find_appropriate_compiler(self):
        ...
        for c_name, c_output in compilers:
            thelab.support.unlink(c_name)
            self.addCleanup(thelab.support.unlink, c_name)
